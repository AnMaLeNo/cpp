...
{
	if (_hit <= 0)
		std::cout << "\033[38;2;241;196;15m" << "Not enough hit points to attack" << "\033[0m" << std::endl;
	else if (_energy <= 0)
		std::cout << "\033[38;2;241;196;15m" << "Not enough energy points to attack" << "\033[0m" << std::endl;
	else
	{
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (_hit == INT32_MIN)
	{
		std::cout << "\033[38;2;241;196;15m" << "Not enough hit points to take damage" << "\033[0m" << std::endl;
	}
	else
	{
		...
		_hit -= amount;
		std::cout << "\033[38;5;88m" << amount << " hit point lost. (" << _hit << ")\033[0m" << std::endl;
	}
}
...
{
	if (_hit == INT32_MAX)
		std::cout << "\033[38;2;241;196;15m" << "Hit points full" << "\033[0m" << std::endl;
	else if (_energy <= 0)
		std::cout << "\033[38;2;241;196;15m" << "Not anough energy to repair" << "\033[0m" << std::endl;
	else
	{
